...
//*****************************USERNAME AND PASSWORD*****************************************
    ...
    Label label_Sportso=new Label("Enter your fav Sports");
    Button signupTolog=new Button("Back");

     String checkuser,checkpass;
    @Override
    public void start(Stage stage) throws IOException,WriteException {
        String path="C:\\Users\\ZAIN\\IdeaProjects\\new final\\Student Record Management System\\workbook.xls";
...
//                checkpass = "";
       ...
       // gp2.add(feeRecB,3,5);
        ...
        RadioButton UnPaidfee = new RadioButton("UnPaid ");
        ToggleGroup fee = new ToggleGroup();
        Paid.setToggleGroup(fee);
        UnPaidfee.setToggleGroup(fee);
        ...
        gpRegister.addRow(7, feestatus, UnPaidfee, Paid);
...
// Create a new sheet
    ...
    WritableCell cell=  new jxl.write.Label(0,looper,textArea.getText());
    System.out.println("looper"+looper);
    System.out.println(String.valueOf(textArea));
    sheet.addCell(cell);
...
// Create a new sheet
                            ...
                            WritableCell cell=  new jxl.write.Label(1,olooper,textArea.getText());
                            System.out.println("looper"+olooper);
                            System.out.println(String.valueOf(textArea));
                            sheet.addCell(cell);
...
////
        ...
        signupTolog.setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
                stage_SignUp.close();
                stage.show();
...
//        WritableCell cell2=  new Label(1,1,"qamar");
